                            ...
                            @if ($mediaType === 'video')
                                ...
                                @else
                                    ...
                                    <button class="media-toggle" type="button" aria-label="Play or pause video">
                                        <span class="app-icon icon-play media-play-icon" aria-hidden="true"></span>
                                        <span class="app-icon icon-pause media-pause-icon" aria-hidden="true"></span>
                                    </button>
                                    <div class="shorts-volume">
                                        <button type="button" data-volume-button aria-label="Control volume">
                                            <span class="app-icon icon-volume volume-on-icon" aria-hidden="true"></span>
                                            <span class="app-icon icon-volume-muted volume-muted-icon" aria-hidden="true"></span>
                                        </button>
